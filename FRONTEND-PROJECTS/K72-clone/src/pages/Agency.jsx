  ...
  return (
    <div>
      <div className='section1 relative py-1'>
        <div ref={imageDivRef} className='absolute  lg:h-[20vw] lg:w-[15vw] h-[35vw] w-[30vw]  lg:top-60 sm:top-80 top-90 left-[30vw] lg:rounded-3xl rounded-2xl overflow-hidden'>
        ...
        <div className='font-[font2] relative'>
          ...
          <div className='lg:pl-[40%] p-5'>
            <p className='lg:text-6xl text-3xl'>&nbsp;&nbsp;&nbsp;We’re inquisitive and open-minded, and we make sure creativity crowds out ego from every corner. A brand is a living thing, with values, a personality and a story. If we ignore that, we can achieve short-term success, but not influence that goes the distance. We bring that perspective to every brand story we help tell.</p>
          </div>
        </div>
      </div>
