...
const Navfull = () => {
    return (
        <div className='w-full h-screen bg-black text-white font-[font2]'>
            <div className='h-2/10 border-b border-gray-400 flex justify-between'>
                ...
                <div>
                <RiCloseLargeLine className='h-full w-full hover:text-lime-300' />
                </div>
            </div>
            <div className='h-6/10'>
                <Link to='/projects'>
                <div className='h-1/4 border-b border-gray-300 relative'>
                    <h1 className='h-full p-3 text-8xl text-center font-bold'>WORK</h1>
                    <div className='absolute bg-lime-300 h-full text-black flex top-0'>
               ...
               <div className='h-1/4 border-b border-gray-300 relative'>
                ...
                <div className='w-full h-1/4 border-b border-gray-300'>
                    <h1 className='h-full w-full p-3 text-8xl text-center font-bold'>CONTACT</h1>
                ...
                <div className='w-full h-1/4 border-b border-gray-300'>
                    <h1 className='h-full w-full p-3 text-8xl text-center font-bold'>BLOG</h1>
                    <div className='hidden'>
                        <h2>READ ARTICLES</h2>
                        <img src="" alt="" />
                        <h2>READ ARTICLES</h2>
            ...
            <div className='h-2/10 flex w-full items-end p-2 font-[font1] font-extralight uppercase text-[10px]'>
