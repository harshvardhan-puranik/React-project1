...
const Navfull = () => {
  ...
  return (
    <div
      ref={fullscreennav}
      id="fullscreennav"
      className="fullscreennav absolute hidden overflow-hidden z-50 w-full h-screen text-white font-[font2]"
    >
      ...
      <div ref={fullLinksNavRef} className="relative h-full w-full">
        ...
        <div className="h-6/10">
          <Link to="/projects">
            <div className="link origin-top h-1/4 border-b border-gray-300 relative">
              <h1 className="h-full p-3 lg:text-8xl sm:text-7xl text-6xl flex items-center justify-center font-bold">
                WORK
              </h1>
          ...
          <div className="link origin-top h-1/4 border-b border-gray-300 relative">
            ...
            <div className="moveLink absolute bg-lime-300 h-full text-black flex top-0">
              <div className="moveX items-center flex">
                ...
                <div className="shrink-0 rounded-full h-20 w-60 object-cover">
                  <RiHeart2Fill size={100} />
                </div>
                <h2 className="whitespace-nowrap font-[font2] text-7xl uppercase text-center">
                  send us a fax
                </h2>
          ...
          <div className="link origin-top h-1/4 border-b border-gray-300 relative">
            <h1 className="h-full p-3 lg:text-8xl sm:text-7xl text-6xl flex items-center justify-center font-bold ">BLOG</h1>
            <div className="moveLink absolute bg-lime-300 h-full text-black flex top-0">
              <div className="moveX items-center flex">
                <h2 className="whitespace-nowrap font-[font2] text-7xl uppercase text-center">
                  read articles
        ...
        <div className="date h-2/10 flex w-full items-end p-2 font-[font1] font-extralight uppercase text-[10px]">
          ...
          <div className="w-1/3 flex justify-center gap-2 lg:text-sm sm:text-xs text-[4px] py-2">
            <h3 className="hover:text-lime-300">
          ...
          <div className="w-1/3 flex justify-end gap-2">
            <h2 className="border lg:border-2 border-white hover:border-lime-300 hover:text-lime-300 rounded-full lg:h-10 lg:w-15 sm:h-6 sm:w-10 h-3 w-6 lg:text-4xl flex items-center justify-center  sm:text-2xl text-xs ">
              FB
            </h2>
            <h2 className="border lg:border-2 border-white hover:border-lime-300 hover:text-lime-300 rounded-full lg:h-10 lg:w-15 sm:h-6 sm:w-10 h-3 w-6 lg:text-4xl flex items-center justify-center  sm:text-2xl text-xs">
              IG
